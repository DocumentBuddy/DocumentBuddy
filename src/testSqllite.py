...
sqlite.create_table_places()
#sqlite.insert_data('/exampleData/Unternehmensbefragung/Unternehmensbefragung-2001-kurz.pdf',('Unternehmensbefragung','kfw'), 'Hallo Hallo', 'chat', 'toc', 'AuthorA','', 4, '2018-10-12')
...
sqlite.insert_data("/exampleData/Unternehmensbefragung/Unternehmensbefragung-2001-kurz.pdf", ('Unternehmensbefragung','kfw'), 'Hallo Hallo', 'chat', 'toc', 'AuthorA',('PlaceA','PlaceB'), 4, '2018-10-12')
# Data as array
print("*************************************************")
