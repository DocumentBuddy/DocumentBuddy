...
sqlite.insert_data("/exampleData/Unternehmensbefragung/Unternehmensbefragung-2001-kurz.pdf", ('Unternehmensbefragung','kfw'), 'Hallo Hallo', 'chat', 'toc', 'AuthorA',('PersonA', 'OrgaA'), 4, '2018-10-12',('PlaceA','PlaceB'))
# Data as array
print("*************************************************")
pprint.pprint(sqlite.select_all('main'))
pprint.pprint(sqlite.select_all('keywords'))
pprint.pprint(sqlite.select_all('places'))
...
#sqlite.truncate_database('names')
